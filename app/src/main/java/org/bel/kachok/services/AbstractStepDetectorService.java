package org.bel.kachok.services;
...
import org.bel.kachok.activities.MainActivity;
import org.bel.kachok.models.StepCount;
import org.bel.kachok.persistence.StepCountPersistenceHelper;
import org.bel.kachok.persistence.WalkingModePersistenceHelper;
import org.bel.kachok.utils.UnitUtil;
...
public abstract class AbstractStepDetectorService extends IntentService implements SensorEventListener, SharedPreferences.OnSharedPreferenceChangeListener {
     ...
     */
    public static final String BROADCAST_ACTION_STEPS_DETECTED = "org.bel.privacyfriendlystepcounter.STEPS_DETECTED";
    /**
     * Extra key for new steps which were added since last broadcast.
     */
    public static final String EXTENDED_DATA_NEW_STEPS = "org.bel.privacyfriendlystepcounter.NEW_STEPS";
    /**
     * Extra key for total step count since service start
     */
    public static final String EXTENDED_DATA_TOTAL_STEPS = "org.bel.privacyfriendlystepcounter.TOTAL_STEPS";
    /**
