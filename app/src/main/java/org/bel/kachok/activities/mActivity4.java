...
public class mActivity4 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view.loadUrl("https://iq-body.ru/exercises/i-razgibanie-zapyastii-sidya"); //try js alert
    ...
    public void openDialog(){
        ...
        builder.setView(getLayoutInflater().inflate(R.layout.mactivity4,null));
        builder.show();
