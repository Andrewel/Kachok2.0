...
public class mActivity7 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view.loadUrl("https://iq-body.ru/exercises/i-prisedanija-so-shtangoj"); //try js alert
    ...
    public void openDialog(){
        ...
        builder.setView(getLayoutInflater().inflate(R.layout.mactivity7,null));
        builder.show();
