...
public class mActivity5 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view.loadUrl("https://iq-body.ru/exercises/i-sgibanie-shei-lezga"); //try js alert
    ...
    public void openDialog(){
        ...
        builder.setView(getLayoutInflater().inflate(R.layout.mactivity5,null));
        builder.show();
