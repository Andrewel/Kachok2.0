...
public class mActivity3 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view.loadUrl("https://iq-body.ru/exercises/i-koncentrirovannye-sgibanija-na-biceps"); //try js alert
    ...
    public void openDialog(){
        ...
        builder.setView(getLayoutInflater().inflate(R.layout.mactivity3,null));
        builder.show();
